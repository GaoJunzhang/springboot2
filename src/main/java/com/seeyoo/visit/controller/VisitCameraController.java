...
public class VisitCameraController {
    ...
    public Map<String, Object> getCameraStatis(String startDate, String endDate, int assetsId) {
        ...
        List<VisitCameraBean> visitCameraBeans = visitCameraService.dayVisitCount(Timestamp.valueOf(startDate + " 00:00:00"), Timestamp.valueOf(endDate + " 23:59:59"),assetsId);
        int youngCount = visitCameraService.countByAgeBetweenAndStampBetween(Timestamp.valueOf(startDate + " 00:00:00"), Timestamp.valueOf(endDate + " 23:59:59"),0,18,assetsId);
        int bigYoungCount = visitCameraService.countByAgeBetweenAndStampBetween(Timestamp.valueOf(startDate + " 00:00:00"), Timestamp.valueOf(endDate + " 23:59:59"),19,35,assetsId);
        int midlifecount = visitCameraService.countByAgeBetweenAndStampBetween(Timestamp.valueOf(startDate + " 00:00:00"), Timestamp.valueOf(endDate + " 23:59:59"),36,60,assetsId);
        int oldAgeCount = visitCameraService.countByAgeBetweenAndStampBetween(Timestamp.valueOf(startDate + " 00:00:00"), Timestamp.valueOf(endDate + " 23:59:59"),61,200,assetsId);
    ...
    public Map<String,Object> top10MemberAssets(String startDate, String endDate){
        ...
        Calendar tCalendar = Calendar.getInstance();
        tCalendar.setTime(startCalendar.getTime());
        List<AssetsBean> assetsBeans = visitCameraService.top10MemberAssets(Timestamp.valueOf(startDate + " 00:00:00"), Timestamp.valueOf(endDate + " 23:59:59"));
